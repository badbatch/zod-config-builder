...
[![build-and-deploy](https://github.com/badbatch/zod-config-builder/actions/workflows/build-and-deploy.yml/badge.svg)](https://github.com/badbatch/zod-config-builder/actions/workflows/build-and-deploy.yml)
